...
export interface ButtonProps
  ...
  variant?: "primary" | "secondary" | "destructive" | "default" | "outline";
  size?: "default" | "sm" | "lg" | "icon";
}

const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "secondary", size = "default", ...props }, ref) => {
    // Exact 3 variants defined by Design System:
    // primary: solid, max one per screen
    // secondary: clean crisp outline
    // destructive: uses red severity color #791F1F
    const variants = {
      primary:
      ...
      // Backwards-compatible aliases mapping to the canonical 3:
      default:
    ...
    return (
      <button
        className={cn(
          ...
          variants[variant as keyof typeof variants] || variants.secondary,
          sizes[size],
          className
        )}
        ref={ref}
